...
import com.tencentcloudapi.wemeet.client.LayoutClient;
...
//        });
            // 实例化client
            layoutClient = new LayoutClient(sender);
        }
    }
    @Override
    public QueryLayoutResponse addLayout(AddLayoutRequest request) throws WemeetSdkException {
        //初始化profile
        init();
        return layoutClient.addMeetingLayout(request);
    }
}
