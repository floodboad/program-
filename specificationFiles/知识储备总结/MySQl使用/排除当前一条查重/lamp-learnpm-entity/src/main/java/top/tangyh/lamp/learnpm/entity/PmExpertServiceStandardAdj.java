...
@TableName("PM_EXPERT_SERVICE_STANDARD_ADJ")
@AllArgsConstructor
@Builder
public class PmExpertServiceStandardAdj extends Entity<Long> {
     ...
     * 原扣税支出 
     */
     @TableField(value = "ORIGINAL_TAX_DEDUCTION_EXPENSE ", condition = LIKE)
    private BigDecimal originalTaxDeductionExpense;
    /**
     * 原劳务税费 
     */
     @TableField(value = "ORIGINAL_SERVICE_TAX ", condition = LIKE)
    private BigDecimal originalServiceTax;
    /**
     * 原金额 
     */
     @TableField(value = "ORIGINAL_AMOUNT_MONEY ", condition = LIKE)
    private BigDecimal originalAmountMoney;
    /**
     * 扣税支出 
     */
     @TableField(value = "TAX_DEDUCTION_EXPENSE ", condition = LIKE)
