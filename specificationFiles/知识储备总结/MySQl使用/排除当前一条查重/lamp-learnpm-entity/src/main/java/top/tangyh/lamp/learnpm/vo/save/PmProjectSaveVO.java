...
@Builder
@ApiModel(value = "PmProjectSaveVO", description = "项目信息")
public class PmProjectSaveVO implements Serializable {
    ...
    @NotNull(message = "项目号", groups = SuperEntity.Save.class)
    ...
    @NotNull(message = "项目可支配金额", groups = SuperEntity.Save.class)
    ...
    @NotNull(message = "会议总场次", groups = SuperEntity.Save.class)
    ...
    @NotNull(message = "会议规划剩余场次", groups = SuperEntity.Save.class)
    ...
    @NotNull(message = "合并计税金额", groups = SuperEntity.Save.class)
