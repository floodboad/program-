...
@Builder
@ApiModel(value = "MsFirstLevelSubjectResultVO", description = "一级科目维护")
public class MsFirstLevelSubjectResultVO extends Entity<Long> implements Serializable, EchoVO {
