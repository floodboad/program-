...
@Builder
@ApiModel(value = "PmMeetingExecutionReqAdjustResultVO", description = "会议执行要求调整记录")
public class PmMeetingExecutionReqAdjustResultVO extends Entity<Long> implements Serializable, EchoVO {
