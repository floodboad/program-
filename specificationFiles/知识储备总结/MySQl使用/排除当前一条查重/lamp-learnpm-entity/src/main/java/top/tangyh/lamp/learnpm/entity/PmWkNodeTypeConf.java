...
@TableName("PM_WK_NODE_TYPE_CONF")
@AllArgsConstructor
@Builder
public class PmWkNodeTypeConf extends Entity<Long> {
     ...
     * 节点类型编码 
     */
     @TableField(value = "NODE_TYPE_CODE ", condition = LIKE)
    private String nodeTypeCode;
    /**
     * 视图名称 
     */
     @TableField(value = "VIEW_NAME ", condition = LIKE)
