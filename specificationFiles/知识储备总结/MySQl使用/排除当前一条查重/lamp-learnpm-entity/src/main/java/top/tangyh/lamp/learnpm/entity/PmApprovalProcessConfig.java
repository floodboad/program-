...
@TableName("PM_APPROVAL_PROCESS_CONFIG")
@AllArgsConstructor
@Builder
public class PmApprovalProcessConfig extends Entity<Long> {
     ...
     * 流程名称 
     */
     @TableField(value = "PROCESS_NAME ", condition = EQUAL)
     @NotEmpty(message = "流程名称名称不能为空")
