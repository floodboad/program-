...
@Builder
@ApiModel(value = "MsProjectTypeSettingsUpdateVO", description = "项目类型设置")
public class MsProjectTypeSettingsUpdateVO implements Serializable {
     ...
     * 会议类型设置名称
     */
    @ApiModelProperty(value = "会议类型设置名称")
    @Size(max = 300, message = "会议类型设置名称长度不能超过300")  
    private  String name;
    /**
     * 备注
     */
