...
@Builder
@ApiModel(value = "MsExecutionSessionTypeUpdateVO", description = "执行场次类型")
public class MsExecutionSessionTypeUpdateVO implements Serializable {
    ...
    @Size(max = 300, message = "类型名称长度不能超过300")  
    private  String name;
    /**
     * 备注
     */
