...
@Builder
@ApiModel(value = "MsFirstLevelSubjectUpdateVO", description = "一级科目维护")
public class MsFirstLevelSubjectUpdateVO implements Serializable {
    ...
    @NotEmpty(message = "请填写一级科目编码")
    @Size(max = 300, message = "一级科目编码长度不能超过300")  
    private  String firstSubjectCode;
    /**
     * OA对照码
     */
    @ApiModelProperty(value = "OA对照码")
    @Size(max = 300, message = "OA对照码长度不能超过300")  
