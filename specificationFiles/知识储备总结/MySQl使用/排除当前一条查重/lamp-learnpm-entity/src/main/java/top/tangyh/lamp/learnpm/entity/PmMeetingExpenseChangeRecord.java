...
@TableName("PM_MEETING_EXPENSE_CHANGE_RECORD")
@AllArgsConstructor
@Builder
public class PmMeetingExpenseChangeRecord extends Entity<Long> {
     ...
     * 本次调整金额 
     */
     @TableField(value = "CURRENT_ADJUSTMENT_AMOUNT ", condition = LIKE)
     ...
     * 调整后剩余金额 
     */
     @TableField(value = "AFTER_ADJUST_REMAINING_AMOUNT ", condition = LIKE)
