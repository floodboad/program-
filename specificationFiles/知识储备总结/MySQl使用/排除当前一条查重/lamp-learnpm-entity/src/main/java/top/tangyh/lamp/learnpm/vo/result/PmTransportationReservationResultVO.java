...
@Builder
@ApiModel(value = "PmTransportationReservationResultVO", description = "交通预定")
public class PmTransportationReservationResultVO extends Entity<Long> implements Serializable, EchoVO {
