...
@Builder
@ApiModel(value = "MsLongzhuExpenseTypeSaveVO", description = "七龙珠费用类型设置")
public class MsLongzhuExpenseTypeSaveVO implements Serializable {
    ...
    @Size(max = 300, message = "控制标准长度不能超过300")
    private String   controlStandards;
    /**
     * 会议执行环节
     */
    @ApiModelProperty(value = "会议执行环节")
    @Size(max = 300, message = "会议执行环节长度不能超过300")
