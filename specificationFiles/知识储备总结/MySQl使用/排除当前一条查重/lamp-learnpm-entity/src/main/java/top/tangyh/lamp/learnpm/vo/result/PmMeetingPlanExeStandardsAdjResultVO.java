...
@Builder
@ApiModel(value = "PmMeetingPlanExeStandardsAdjResultVO", description = "会议规划执行标准调整记录")
public class PmMeetingPlanExeStandardsAdjResultVO extends Entity<Long> implements Serializable, EchoVO {
