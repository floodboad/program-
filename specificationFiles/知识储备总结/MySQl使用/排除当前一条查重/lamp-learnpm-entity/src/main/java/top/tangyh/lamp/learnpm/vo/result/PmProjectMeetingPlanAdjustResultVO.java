...
@Builder
@ApiModel(value = "PmProjectMeetingPlanAdjustResultVO", description = "项目会议规划调整")
public class PmProjectMeetingPlanAdjustResultVO extends Entity<Long> implements Serializable, EchoVO {
