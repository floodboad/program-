...
@Builder
@ApiModel(value = "MsLongzhuMeetingTypeResultVO", description = "会议类型七龙珠配置")
public class MsLongzhuMeetingTypeResultVO extends Entity<Long> implements Serializable, EchoVO {
