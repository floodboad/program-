...
@Builder
@ApiModel(value = "PmMeetingPlanExeStandardsResultVO", description = "会议规划执行标准")
public class PmMeetingPlanExeStandardsResultVO extends Entity<Long> implements Serializable, EchoVO {
