...
@Builder
@ApiModel(value = "MsExpertBankCardInfoResultVO", description = "专家银行卡信息")
public class MsExpertBankCardInfoResultVO extends Entity<Long> implements Serializable, EchoVO {
