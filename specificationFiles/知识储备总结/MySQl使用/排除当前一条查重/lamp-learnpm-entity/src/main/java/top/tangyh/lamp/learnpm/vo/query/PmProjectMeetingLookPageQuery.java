...
@Builder
@ApiModel(value = "PmProjectMeetingLookPageQuery", description = "项目会议申请")
public class PmProjectMeetingLookPageQuery implements Serializable {
