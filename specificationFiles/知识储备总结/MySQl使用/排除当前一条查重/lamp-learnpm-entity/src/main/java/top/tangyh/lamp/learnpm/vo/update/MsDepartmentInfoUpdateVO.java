...
@Builder
@ApiModel(value = "MsDepartmentInfoUpdateVO", description = "科室信息")
public class MsDepartmentInfoUpdateVO implements Serializable {
    ...
    @Size(max = 300, message = "编号长度不能超过300")  
    private  String code;
    /**
     * 科室名称
     */
    @ApiModelProperty(value = "科室名称")
    @Size(max = 300, message = "科室名称长度不能超过300")  
    private  String name;
    /**
     * 备注
     */
