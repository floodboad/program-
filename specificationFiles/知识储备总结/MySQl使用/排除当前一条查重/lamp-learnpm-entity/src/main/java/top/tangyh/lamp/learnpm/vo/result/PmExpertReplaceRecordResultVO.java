...
@Builder
@ApiModel(value = "PmExpertReplaceRecordResultVO", description = "专家更换记录")
public class PmExpertReplaceRecordResultVO extends Entity<Long> implements Serializable, EchoVO {
