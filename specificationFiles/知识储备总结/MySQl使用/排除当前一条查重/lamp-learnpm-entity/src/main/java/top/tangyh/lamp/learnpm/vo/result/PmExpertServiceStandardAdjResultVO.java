...
@Builder
@ApiModel(value = "PmExpertServiceStandardAdjResultVO", description = "会议规划专家劳务标准调整记录")
public class PmExpertServiceStandardAdjResultVO extends Entity<Long> implements Serializable, EchoVO {
