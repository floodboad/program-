...
@Builder
@ApiModel(value = "PmProjectStakeholderSaveVO", description = "项目干系人")
public class PmProjectStakeholderSaveVO implements Serializable {
    ...
    @Size(max = 11, message = "用户手机号长度不能超过11")
    private String   phone;
    /**
     * 用户姓名
     */
    @ApiModelProperty(value = "用户姓名")
    @Size(max = 200, message = "用户姓名长度不能超过200")
    private String   name;
    /**
     * 项目角色
     */
