...
@Builder
@ApiModel(value = "PmMeetingMaterialsRegResultVO", description = "会议合规材料登记")
public class PmMeetingMaterialsRegResultVO extends Entity<Long> implements Serializable, EchoVO {
