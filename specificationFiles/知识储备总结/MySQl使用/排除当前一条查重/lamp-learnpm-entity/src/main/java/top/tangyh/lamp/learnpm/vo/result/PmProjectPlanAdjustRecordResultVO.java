...
@Builder
@ApiModel(value = "PmProjectPlanAdjustRecordResultVO", description = "项目规划调整记录")
public class PmProjectPlanAdjustRecordResultVO extends Entity<Long> implements Serializable, EchoVO {
