...
@TableName("PM_ORDER_FOOD")
@AllArgsConstructor
@Builder
public class PmOrderFood extends Entity<Long> {
     ...
     * 订单类型 
     */
     @TableField(value = "ORDER_TYPE ", condition = LIKE)
    private String orderType;
    /**
     * 费用类型 
     */
     @TableField(value = "FEE_TYPE ", condition = LIKE)
     ...
     * 餐费标准 
     */
     @TableField(value = "MEAL_FEE_STANDARD ", condition = LIKE)
     ...
     * 本次订餐人数 
     */
     @TableField(value = "NUMBER_PEOPLE_THIS_TIME ", condition = LIKE)
    private Integer numberPeopleThisTime;
    /**
     * 执行后预算结余金额 
     */
     @TableField(value = "BUDGET_BALANCE_AFTER_EXE ", condition = LIKE)
    private BigDecimal budgetBalanceAfterExe;
    /**
     * 实际消费金额 
     */
     @TableField(value = "ACTUAL_AMOUNT_SHANGQITONG ", condition = LIKE)
