...
@Builder
@ApiModel(value = "MsLongzhuExpenseTypeResultVO", description = "七龙珠费用类型设置")
public class MsLongzhuExpenseTypeResultVO extends Entity<Long> implements Serializable, EchoVO {
