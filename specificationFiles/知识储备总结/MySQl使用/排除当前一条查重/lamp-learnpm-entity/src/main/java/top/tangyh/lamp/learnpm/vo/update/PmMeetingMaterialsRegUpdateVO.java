...
@Builder
@ApiModel(value = "PmMeetingMaterialsRegUpdateVO", description = "会议合规材料登记")
public class PmMeetingMaterialsRegUpdateVO implements Serializable {
    ...
    @Size(max = 300, message = "材料类型名称长度不能超过300")  
