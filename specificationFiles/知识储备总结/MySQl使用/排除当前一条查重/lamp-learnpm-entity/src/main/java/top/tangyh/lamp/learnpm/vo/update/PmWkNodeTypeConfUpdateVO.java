...
@Builder
@ApiModel(value = "PmWkNodeTypeConfUpdateVO", description = "工作流节点类型配置")
public class PmWkNodeTypeConfUpdateVO implements Serializable {
    ...
    @Size(max = 300, message = "视图名称长度不能超过300")  
