...
<script lang="ts">
  ...
  import { page } from '/@/api/learnpm/pm/defUser';
  import { userColumns, userSearchFormSchema } from '/@/views/learnpm/pm/defUser/defUser.data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerTable, { reload, getSelectRowKeys, clearSelectedRowKeys, getSelectRows }] =
        useTable({
          title: '选择用户信息',
          api: page,
          columns: userColumns,
